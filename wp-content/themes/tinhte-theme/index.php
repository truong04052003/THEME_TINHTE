...
<div class="page-layout">
    <div class="container">
        <div class="row">
            <div class="col-12 additional-padding">
                        ...
                        <div class=" facts-container">
                                        ...
                                        <div class="fact-new">
                                            <a href="" class="">
                                                <div class="preview-view-fact">
                                                    <div class="avatar-fact">
                                                        <img src="<?= $theme_uri; ?>/img/avatar_male_m.png" alt="">
                            ...
                            <div class="item-main">
                                <div class="preview-view">
                                    <img src="<?= $theme_uri; ?>/img/story4.jpg" alt="" class="preview-img">
                                        ...
                                        <button class="preview-avatar">
                                            <a href="" class="avatar-story">
                                                <span class="image-loader">
                                                    ...
                                                    <img src="<?= $theme_uri; ?>/img/icon.jpg" alt="" class="preview-img-icon">
                                                </span>
                                            </a>
                                        </button>
                            ...
                            <div class="item-main">
                                <button class="load-more-container button-main button-light">
                                    ...
                                    <p class="load-more">Bấm vào để <br>xem nhiều<br> hơn</p>
                                </button>
                            </div>
                        </div>
                    </div>
                                ...
                                <a href="" class="first-name">
                                    <div class="thumb-wrapper">
                                        <div class="thumb no-border">
                                            <img src="<?= $theme_uri; ?>/img/cafe1.jpg" alt="" class="main-img">
                                        </div>
                                    </div>
                                </a>
                                <article class="body">
                        ...
                        <li class="news-img">
                            ...
                            <div class="main second">
                                <a href="">
                                    <div class="thumb-wrapper">
                                        <div class="thumb no-border">
                                            <img src="<?= $theme_uri; ?>/img/android.jpg" alt="" class="android">
                                        </div>
                                    </div>
                                </a>
                                <article class="body">
                        ...
                        <li class="news-image">
                            ...
                            <div class="main">
                                <a href="">
                                    <div class="thumb-wrapper">
                                        <div class="thumb no-border">
                                            <img src="<?= $theme_uri; ?>/img/xecuuhoa.jpg" alt="" class="main-image">
                                        </div>
                                    </div>
                                </a>
                                <article class="body">
                                        ...
                                        <div class="img-sidebar">
                                            <div class="thumb-wrapper">
                                                <div class="thumb-img no-border">
                                                    <img src="<?= $theme_uri; ?>/img/sidebar1.jpg" alt="" class="image-sidebar main-img-sidebar">
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                ...
                                <a href="">
                                    <article class="item-thread">
                                        ...
                                        <div class="img-sidebar">
                                            <div class="thumb-wrapper">
                                                <div class="thumb-img no-border">
                                                    <img src="<?= $theme_uri; ?>/img/sidebar2.jpg" alt="" class="image-sidebar main-img-sidebar">
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                ...
                                <a href="">
                                    <article class="item-thread">
                                        ...
                                        <div class="img-sidebar">
                                            <div class="thumb-wrapper">
                                                <div class="thumb-img no-border">
                                                    <img src="<?= $theme_uri; ?>/img/sidebar3.jpg" alt="" class="image-sidebar main-img-sidebar">
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                ...
                                <a href="">
                                    <article class="item-thread">
                                        ...
                                        <div class="img-sidebar">
                                            <div class="thumb-wrapper">
                                                <div class="thumb-img no-border">
                                                    <img src="<?= $theme_uri; ?>/img/sidebar4.jpg" alt="" class=" image-sidebar main-img-sidebar">
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                ...
                                <a href="">
                                    <article class="item-thread">
                                        ...
                                        <div class="img-sidebar">
                                            <div class="thumb-wrapper">
                                                <div class="thumb-img no-border">
                                                    <img src="<?= $theme_uri; ?>/img/sidebar5.jpg" alt="" class="image-sidebar main-img-sidebar">
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                ...
                                <a href="">
                                    <article class="item-thread">
                                        ...
                                        <div class="img-sidebar">
                                            <div class="thumb-wrapper">
                                                <div class="thumb-img no-border">
                                                    <img src="<?= $theme_uri; ?>/img/sidebar6.jpg" alt="" class="image-sidebar main-img-sidebar">
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                ...
                                <a href="">
                                    <article class="item-thread">
                                        ...
                                        <div class="img-sidebar">
                                            <div class="thumb-wrapper">
                                                <div class="thumb-img no-border">
                                                    <img src="<?= $theme_uri; ?>/img/sidebar7.jpg" alt="" class="image-sidebar main-img-sidebar">
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                ...
                                <a href="">
                                    <article class="item-thread">
                                        ...
                                        <div class="img-sidebar">
                                            <div class="thumb-wrapper">
                                                <div class="thumb-img no-border">
                                                    <img src="<?= $theme_uri; ?>/img/sidebar8.jpg" alt="" class="image-sidebar main-img-sidebar">
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                    ...
                    <div class="threads-wp">
                        <a href="" class="thread-wp">
                            ...
                            <div class="thread-content">
                                <p class="thread-title-left">Trên tay Xiaomi 13 Ultra: màn hình đẹp,
                                    tổng thể ổn</p>
                        ...
                        <a href="" class="thread-wp">
                            ...
                            <div class="thread-content">
                                <p class="thread-title-left">VIETMAP ra mắt màn hình giải trí TEYES
                        ...
                        <a href="" class="thread-wp">
                            ...
                            <div class="thread-content">
                                <p class="thread-title-left">[Tản mạn] Uy tín trên mạng và niềm vui
                                    của sự ẩn danh</p>
                        ...
                        <a href="" class="thread-wp">
                            ...
                            <div class="thread-content">
                                <p class="thread-title-left">Big Wind, xe cứu hoả dùng động cơ máy bay
                                    phản lực</p>
                        ...
                        <a href="" class="thread-wp">
                            ...
                            <div class="thread-content">
                                <p class="thread-title-left">Trên tay pin dự phòng Baseus 20000mAh
                        ...
                        <a href="" class="thread-wp">
                            ...
                            <div class="thread-content">
                                <p class="thread-title-left">Tôn vinh “Tinh hoa nghề bún” Tại Festival
                    ...
                    <div class="threads-header">
                            ...
                            <a href="" class="thongtin-review">
                                <div class="thumb-wrapper-header">
                                    <div class="thumb-header no-border-header">
                                        <img src="<?= $theme_uri; ?>/img/item1.png" alt="" class="item main-img-header">
                                    </div>
                                </div>
                        ...
                        <div class="item-header">
                            <a href="" class="thongtin-review">
                                <div class="thumb-wrapper-header">
                                    <div class="thumb-header no-border-header">
                                        <img src="<?= $theme_uri; ?>/img/item2.jpg" alt="" class="item main-img-header">
                                    </div>
                                </div>
                        ...
                        <div class="item-header">
                            <a href="" class="thongtin-review">
                                <div class="thumb-wrapper-header">
                                    <div class="thumb-header no-border-header">
                                        <img src="<?= $theme_uri; ?>/img/item3.jpg" alt="" class="item main-img-header">
                                    </div>
                                </div>
                        ...
                        <div class="item-header">
                            <a href="" class="thongtin-review">
                                <div class="thumb-wrapper-header">
                                    <div class="thumb-header no-border-header">
                                        <img src="<?= $theme_uri; ?>/img/item4.jpg" alt="" class="item main-img-header">
                                    </div>
                                </div>
                        ...
                        <div class="item-header">
                            <a href="" class="thongtin-review">
                                <div class="thumb-wrapper-header">
                                    <div class="thumb-header no-border-header">
                                        <img src="<?= $theme_uri; ?>/img/item5.jpg" alt="" class="item main-img-header">
                                    </div>
                                </div>
                        ...
                        <div class="item-header">
                            <a href="" class="thongtin-review">
                                <div class="thumb-wrapper-header">
                                    <div class="thumb-header no-border-header">
                                        <img src="<?= $theme_uri; ?>/img/item6.jpg" alt="" class="item main-img-header">
                                    </div>
                                </div>
                        ...
                        <div class="item-header">
                            <a href="" class="thongtin-review">
                                <div class="thumb-wrapper-header">
                                    <div class="thumb-header no-border-header">
                                        <img src="<?= $theme_uri; ?>/img/item7.jpg" alt="" class="item main-img-header">
                                    </div>
                                </div>
                        ...
                        <div class="item-header">
                            <a href="" class="thongtin-review">
                                <div class="thumb-wrapper-header">
                                    <div class="thumb-header no-border-header">
                                        <img src="<?= $theme_uri; ?>/img/item8.jpg" alt="" class="item main-img-header">
                                    </div>
                                </div>
                        ...
                        <div class="item-header">
                            <a href="" class="thongtin-review">
                                <div class="thumb-wrapper-header">
                                    <div class="thumb-header no-border-header">
                                        <img src="<?= $theme_uri; ?>/img/item9.jpg" alt="" class="item main-img-header">
                                    </div>
                                </div>
                        ...
                        <div class="item-header">
                            <a href="" class="thongtin-review">
                                <div class="thumb-wrapper-header">
                                    <div class="thumb-header no-border-header">
                                        <img src="<?= $theme_uri; ?>/img/item10.jpg" alt="" class="item main-img-header">
                                    </div>
                                </div>
                                                    ...
                                                    <div class="lazyload">
                                                        <div class="thumb-wrapper">
                                                            <div class="thumb-no-hd no-border ">
                                                                <img src="<?= $theme_uri; ?>/img/header1.jpg" alt="" class="main-img-header">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <a href="" class="article-wrapper">
                                                <div class="img-wrapper">
                                                    <div class="lazyload">
                                                        <div class="thumb-wrapper">
                                                            <div class="thumb-no-hd no-border ">
                                                                <img src="<?= $theme_uri; ?>/img/header2.jpg" alt="" class="main-img-header">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="info-avt">
                                                <div class="left-avt">
                                                    <a href="" class="avatar-avt">
                                                        <span class="image-loader-avt">
                                                            <span class="spacer"></span>
                                                            <img src="<?= $theme_uri; ?>/img/avt2.jpg" alt="" class="image-avt">
                                                        </span>
                                                    </a>
                                                    <span class="author">thanhtung6868</span>
                                                    <div class="subbrand">
                                                        <a href="" class="logo-name">
                                                            <img src="<?= $theme_uri; ?>/img/logonho.jpg" alt="" class="logo-img">
                                            ...
                                            <a href="" class="article-wrapper">
                                                <div class="img-wrapper">
                                                    <div class="lazyloadr">
                                                        <div class="thumb-wrapper">
                                                            <div class="thumb-no-hd no-border ">
                                                                <img src="<?= $theme_uri; ?>/img/header3.jpg" alt="" class="main-img-header">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="info-avt">
                                                <div class="left-avt">
                                                    <a href="" class="avatar-avt">
                                                        <span class="image-loader-avt">
                                                            <span class="spacer"></span>
                                                            <img src="<?= $theme_uri; ?>/img/avt3.jpg" alt="" class="image-avt">
                                                        </span>
                                                    </a>
                                                    <span class="author">vn_ninja</span>
                                                </div>
                                            ...
                                            <a href="" class="article-wrapper">
                                                <div class="img-wrapper">
                                                    <div class="lazyload">
                                                        <div class="thumb-wrapper">
                                                            <div class="thumb-no-hd no-border ">
                                                                <img src="<?= $theme_uri; ?>/img/header4.jpg" alt="" class="main-img-header">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="info-avt">
                                                <div class="left-avt">
                                                    <a href="" class="avatar-avt">
                                                        <span class="image-loader-avt">
                                                            <span class="spacer"></span>
                                                            <img src="<?= $theme_uri; ?>/img/avt4.jpg" alt="" class="image-avt">
                                                        </span>
                                                    </a>
                                            ...
                                            <div class="category-wp">
                                                        ...
                                                        <div class="thumbnail-wrapper">
                                                            <div class="lazyload-wrapper">
                                                                <div class="thumb-wrapper wp">
                                                                    <div class="thumb no-border">
                                                                        <img src="<?= $theme_uri; ?>/img/xe.jpg" alt="" class="main-img-category">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="headline-left">Xe
                                                                Tinhte</div>
                                                            <img src="<?= $theme_uri; ?>/img/logonho.jpg" alt="" class="subbrand-img">
                                                        </div>
                                                    </div>
                                                </a>
                                                <ul class="threads-category">
                                                    ...
                                                    <div class="more-threads">
                                                        <a href="" class="button-wp button-size button-secondary">Xem
                                                            tất cả</a>
                                                    </div>
                                                </ul>
                                            </div>
                                                    ...
                                                    <div class="primary-category">
                                                        <div class="thumbnail-wrapper">
                                                            <div class="lazyload-wrapper">
                                                                <div class="thumb-wrapper wp">
                                                                    <div class="thumb no-border ">
                                                                        <img src="<?= $theme_uri; ?>/img/mic.jpg" alt="" class="main-img-category">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="background-category"></div>
                                                            ...
                                                            <img src="<?= $theme_uri; ?>/img/logomic.png" alt="" class="subbrand-img">
                                                        </div>
                                                    </div>
                                                </a>
                                                <ul class="threads-category">
                                ...
                                <div class="login-containers">
                                    <div class="login-foru">
                                        <div class="image-login">
                                            <img src="<?= $theme_uri; ?>/img/logo-login.png" class="">
                                        </div>
                                ...
                                <div class="deeptalk-containers">
                                    <div class="header-container">
                                        <a href="" class="line-deeptalk">
                                            <img src="<?= $theme_uri; ?>/img/logo-dt.png" class="deeptalk-logo">
                                                        ...
                                                        <div class="thumbnail-dt">
                                                            <div class="thumb-dt">
                                                                <div class="thumb-deep border-deep">
                                                                    <img src="<?= $theme_uri; ?>/img/kem.jpg" class="img-dt">
                                                                </div>
                                                            </div>
                                                ...
                                                <a href="" class="item">
                                                    <article class="">
                                                        <div class="thumbnail-dt ">
                                                            ...
                                                            <div class="title-deep"><span class="thread-dt">Deeptalk:
                                                ...
                                                <a href="" class="item">
                                                    <article class="">
                                                        <div class="thumbnail-dt ">
                                                            ...
                                                            <div class="title-deep"><span class="thread-dt">Những
                                                ...
                                                <a href="" class="item">
                                                    <article class="">
                                                        <div class="thumbnail-dt ">
                                                            ...
                                                            <div class="title-deep"><span class="thread-dt">Benin -
                                                ...
                                                <div class="thumbnail-hot">
                                                    <div class="wrapper-hot">
                                                        <div class="thumb-hot border-hot">
                                                            <img src="<?= $theme_uri; ?>/img/header1.jpg" class="image-hot">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <a href="" class="item-hot">
                                            <article class="article-hot">
                                                ...
                                                <div class="content-hot">
                                                    ...
                                                    <h5 class="thread-hot">
                                                        <span title="Truyền thông xã hội thực sự đang hấp hối" class="text-hot">Truyền thông xã hội thực sự
                                                            đang hấp hối</span>
                                                    </h5>
                                                </div>
                                            </article>
                                    ...
                                    <div class="body-youtube">
                                            ...
                                            <h3 class="name-yt">
                                                <a href="https://youtube.com/user/tinhtevideo" class="link-yt">
                                                    <svg width="30" height="22" viewBox="0 0 30 22" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M29.249 3.643c-.344-1.337-1.356-2.39-2.641-2.748-2.33-.65-11.671-.65-11.671-.65s-9.342 0-11.672.65C1.98 1.252.968 2.305.625 3.643 0 6.066 0 11.123 0 11.123s0 5.056.624 7.48c.344 1.337 1.356 2.39 2.641 2.747 2.33.65 11.672.65 11.672.65s9.341 0 11.671-.65c1.285-.357 2.297-1.41 2.641-2.747.624-2.424.624-7.48.624-7.48s0-5.057-.624-7.48" fill="#D9252A">
                                                        </path>
                                                        <path fill="#FFFFFE" d="M11.95 15.784l7.76-4.661-7.76-4.662v9.323">
                                                        </path>
                                                    </svg>
                                        ...
                                        <div class="display-yt">
                                            <div class="main-video">
                                                <div class="iframe-yt">
                                                    <iframe width="100%" height="100%" allowfullscreen="" src="https://www.youtube.com/embed/Lt_afXS9wVc" frameborder="0" allow="autoplay; encrypted-media" class="video-display">
                                                    </iframe>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <ol class="videos">
                                                <li class="all-yt active-yt">
                                                    <button class="videoRow">
                                                        <div class="lazyload">
                                                            <img src="<?= $theme_uri; ?>/img/sofa.jpg" class="thumb-yt">
                                                        </div>
                ...
                <div class="community-tinhte">
                    ...
                    <div>
                        <a class="banner-sidebar" href="">
                            <img class="tinhte-banner" src="<?= $theme_uri; ?>/img/sidebar.jpg">
                        </a>
                    </div>
                    <br>
                    <div class="community-main">
                                ...
                                <a href="" class="main-tt">
                                    <div class="thumb-tt">
                                        <span class="image-tt">
                                            ...
                                            <img src="<?= $theme_uri; ?>/img/congdong1.jpg" class="img-community">
                                        </span>
                                    </div>
                                    <div class="info-tt">
                                ...
                                <a href="" class="main-tt">
                                    <div class="thumb-tt">
                                        <span class="image-tt">
                                            ...
                                            <img src="<?= $theme_uri; ?>/img/congdong2.jpg" class="img-community">
                                        </span>
                                    </div>
                                    <div class="info-tt">
                                ...
                                <a href="" class="main-tt">
                                    <div class="thumb-tt">
                                        <span class="image-tt">
                                            ...
                                            <img src="<?= $theme_uri; ?>/img/congdong3.jpg" class="img-community"></span>
                                    </div>
                                    <div class="info-tt">
                                ...
                                <a href="" class="main-tt">
                                    <div class="thumb-tt">
                                        <span class="image-tt">
                                            ...
                                            <img src="<?= $theme_uri; ?>/img/congdong4.jpg" class="img-community"></span>
                                    </div>
                                    <div class="info-tt">
                        ...
                        <button class="button-community-tt">
                            <a href="" class="button-tt">Xem tất cả (
                                <!-- -->84
                                <!-- -->)
                            </a>
                        </button>
                                ...
                                <div class="title-tips">Thủ thuật Tinh tế
                                    <span class="icon-tips">
                                        <svg width="38" height="41" viewBox="0 0 38 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M9.55 11.945H7.813a1.26 1.26 0 0 0-1.26 1.26v4.532a1.261 1.261 0 0 0 1.26 1.26H9.55c.28.991.676 1.934 1.173 2.813l-1.22 1.211a1.26 1.26 0 0 0 0 1.79l1.592 1.582 1.64 1.629a1.261 1.261 0 0 0 1.777 0l.006-.006 1.226-1.218c.884.494 1.833.887 2.83 1.168v1.716c0 .696.564 1.26 1.26 1.26h4.58c.322 0 .617-.12.84-.322.258-.23.42-.565.42-.938v-1.716c.998-.281 1.945-.674 2.831-1.168l1.23 1.223a1.26 1.26 0 0 0 1.778 0l3.232-3.21a1.261 1.261 0 0 0 0-1.79l-1.22-1.211a12.89 12.89 0 0 0 1.175-2.812h1.734c.697 0 1.261-.565 1.261-1.261v-4.531a1.26 1.26 0 0 0-1.26-1.261H34.7a12.895 12.895 0 0 0-1.175-2.813l1.22-1.211a1.261 1.261 0 0 0 0-1.79l-3.232-3.21a1.261 1.261 0 0 0-1.777 0l-1.23 1.223a13.007 13.007 0 0 0-2.832-1.166V1.26C25.674.565 25.11 0 24.414 0h-4.58c-.696 0-1.26.565-1.26 1.26v1.718c-.997.279-1.946.672-2.83 1.166L14.512 2.92a1.26 1.26 0 0 0-1.777 0L9.502 6.131a1.26 1.26 0 0 0 .001 1.79l1.22 1.211c-.497.88-.892 1.822-1.173 2.813zm13.224 9.277a5.805 5.805 0 0 1-5.773-3.026 5.746 5.746 0 0 1-.682-2.725c0-3.196 2.598-5.788 5.805-5.788s5.806 2.592 5.806 5.788c0 2.977-2.255 5.429-5.156 5.751z" fill="#3C6EAA"></path>
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M31.153 15.471a9.029 9.029 0 1 0-18.057 0 9.029 9.029 0 0 0 18.057 0zm-9.028 5.787a5.801 5.801 0 0 1-5.102-3.025l-.02-.038a5.745 5.745 0 0 1-.683-2.724c0-3.197 2.598-5.788 5.805-5.788 3.206 0 5.806 2.591 5.806 5.788 0 2.976-2.255 5.429-5.156 5.75a5.66 5.66 0 0 1-.65.037z" fill="#23D7A9"></path>
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M0 27.446v3.453c0 .53.43.96.96.96h1.323c.214.755.516 1.474.895 2.143l-.93.923a.96.96 0 0 0 0 1.364l2.463 2.446a.96.96 0 0 0 1.354 0l.938-.933a9.95 9.95 0 0 0 2.156.89v1.307c0 .531.43.961.961.961h3.489c.53 0 .96-.43.96-.96v-1.308a9.956 9.956 0 0 0 2.157-.89l.938.932a.96.96 0 0 0 1.354 0l2.462-2.446a.96.96 0 0 0 0-1.363l-.93-.923c.38-.67.681-1.388.896-2.143h1.322c.53 0 .96-.43.96-.96v-3.453a.96.96 0 0 0-.96-.96h-1.322a9.805 9.805 0 0 0-.895-2.143l.93-.924a.96.96 0 0 0 0-1.363l-2.463-2.446a.96.96 0 0 0-1.354 0l-.938.932a9.905 9.905 0 0 0-2.157-.888v-1.308a.96.96 0 0 0-.96-.961H10.12a.96.96 0 0 0-.96.96v1.309a9.89 9.89 0 0 0-2.157.888l-.938-.933a.96.96 0 0 0-1.354 0l-2.463 2.447a.96.96 0 0 0 0 1.363l.93.924a9.758 9.758 0 0 0-.894 2.142H.96a.96.96 0 0 0-.961.961zm16.288 1.726c0 2.436-1.98 4.41-4.424 4.41a4.416 4.416 0 0 1-4.423-4.41c0-2.435 1.98-4.41 4.423-4.41a4.417 4.417 0 0 1 4.424 4.41z" fill="#4E8AD1"></path>
                                            <path d="M11.864 22.293a6.879 6.879 0 1 1 0 13.758 6.879 6.879 0 0 1 0-13.758z" fill="#EFEADD"></path>
                                            <path d="M11.864 33.582a4.417 4.417 0 0 0 4.424-4.41c0-2.435-1.98-4.41-4.424-4.41a4.416 4.416 0 0 0-4.423 4.41c0 2.436 1.98 4.41 4.423 4.41z" fill="#4E8AD1"></path>
                                        </svg>
                                    </span>
                                </div>
                            </div>
                            <div class="body-tips">
                                <div class="article-tips">
                                    <a href="">
                                        <div class="main-tip reverse-tip">
                                            <div class="image-tip">
                                                <img src="<?= $theme_uri; ?>/img/tip.jpg" class="real-image-tip">
                                            </div>
                                ...
                                <div class="article-tips">
                                    <a href="">
                                        <div class="main-tip reverse-tip">
                                            <div class="image-tip">
                                                <img src="<?= $theme_uri; ?>/img/tip2.jpg" class="real-image-tip">
                                            </div>
                                            <div class="content-tip">
                                ...
                                <div class="article-tips">
                                    <a href="">
                                        <div class="main-tip reverse-tip">
                                            <div class="image-tip">
                                                <img src="<?= $theme_uri; ?>/img/tip3.jpg" class="real-image-tip">
                                            </div>
                                            <div class="content-tip">
                                ...
                                <div class="article-tips">
                                    <a href="">
                                        <div class="main-tip reverse-tip">
                                            <div class="image-tip">
                                                <img src="<?= $theme_uri; ?>/img/tip4.jpg" class="real-image-tip">
                                            </div>
                                            <div class="content-tip">
                                ...
                                <div class="article-tips">
                                    <a href="">
                                        <div class="main-tip reverse-tip">
                                            <div class="image-tip">
                                                <img src="<?= $theme_uri; ?>/img/tip5.jpg" class="real-image-tip">
                                            </div>
                                            <div class="content-tip">
                                ...
                                <div class="article-tips">
                                    <a href="">
                                        <div class="main-tip reverse-tip">
                                            <div class="image-tip">
                                                <img src="<?= $theme_uri; ?>/img/tip6.jpg" class="real-image-tip">
                                            </div>
                                            <div class="content-tip">
                                ...
                                <div class="article-tips">
                                    <a href="">
                                        <div class="main-tip reverse-tip">
                                            <div class="image-tip">
                                                <img src="<?= $theme_uri; ?>/img/tip7.jpg" class="real-image-tip">
                                            </div>
                                            <div class="content-tip">
                                ...
                                <div class="article-tips">
                                    <a href="">
                                        <div class="main-tip reverse-tip">
                                            <div class="image-tip">
                                                <img src="<?= $theme_uri; ?>/img/tip8.jpg" class="real-image-tip">
                                            </div>
                                            <div class="content-tip">
                                ...
                                <div class="article-tips">
                                    <a href="">
                                        <div class="main-tip reverse-tip">
                                            ...
                                            <div class="content-tip"><span class="title-tip thread-title-tip">Cách
                                                    để "force
...
<!-- MŨi tên đưa lên đầu trang -->
<div class="">
    <button onclick="scrollToTop()" class="button-scroll">
        <i class="fas-scroll fa-up-scroll">
            <img src="<?= $theme_uri; ?>/img/muiten.png" class="image-scroll">
        </i>
    </button>
</div>
